...
![Procure Lite 界面概览](./docs/assets/github/procure-lite-overview.svg)

![采购闭环流程](./docs/assets/github/procurement-flow.svg)

![VPS Docker 部署与 PWA 访问](./docs/assets/github/deployment-pwa.svg)
